...
class FileLibraryPermissionsTask extends Shell {
	...
	*/
	...
	function execute() {	
		...
		$this->allow(array('model'=>'Group','foreign_key'=>USER_GROUP_CONTRIBUTOR), 'controllers/FileLibrary/FileLibraryFiles');
		$this->allow(array('model'=>'Group','foreign_key'=>USER_GROUP_CONTRIBUTOR), 'controllers/FileLibrary/FileLibraryFolders');
